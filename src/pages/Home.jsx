  ...
  return (
    <div>
        <form onSubmit={handleSubmit}>
            ...
            <input type='text' name='username' placeholder='UserName' value={data.usernamename} onChange={handleInput}/>
            ...
            <div>
                <input type='checkbox' name='checkbox' id='checkbox' value={data.checkbox} onChange={handleInput}/>
